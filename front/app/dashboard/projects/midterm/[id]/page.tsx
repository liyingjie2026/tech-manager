...
export default function MidtermDetailPage({ params }: { params: { id: string } }) {
  const { id } = params
...
预期成果：1.掌握高温岩体高效钻进技术，提出高温地热井井筒稳定性术了多参数，形成地热井高效取热与综合利用技术，打造示范应用基地；2.发表高水平论文4—5篇；3.获授权国家发明专利2—3项；4.获得国家及省部级级项目2—3项。实用1-2项。`,
  ...
  const uploadedAttachments = isViewMode
    ? [
        { name: "中期检查报告.docx", size: "3.2 MB", type: "项目任务书" },
      ...
      <div className="border-b bg-card">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-bold">中期检查详情</h1>
              <p className="text-sm text-muted-foreground">查看中期检查信息</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <CardContent className="p-6">
            ...
            {!isViewMode && (
              <Alert className="mb-4">
                ...
                <AlertDescription>
                  请上传中期检查所需的附件材料。支持 jpg/jpeg/png, pdf, doc/docx, xls/xlsx, ppt/pptx
                  格式，单个文件不超过 4M。
                </AlertDescription>
              </Alert>
            )}
